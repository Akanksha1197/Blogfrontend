...
const BlogPage: React.FC= () => {
  ...
  useEffect(() => {
    ...
    const fetchPost = async () => {
      try {
        const response = await fetch(`https://blogappbackend-980x75kmb-akankshas-projects-76b3734f.vercel.app/api/category/${id}`);
        if (response.ok) {
  ...
  const Delete=async(postId:string)=>{
    ...
    const response=await fetch(`https://blogappbackend-980x75kmb-akankshas-projects-76b3734f.vercel.app/api/delete/${postId}`,{
      method:'DELETE',
      headers: {
...
try {
  ...
  const response=await fetch('https://blogappbackend-980x75kmb-akankshas-projects-76b3734f.vercel.app/api/comment/newcomment',{
    method:"POST",
   headers:{
...
try {
  const response=await fetch(`https://blogappbackend-980x75kmb-akankshas-projects-76b3734f.vercel.app/api/comment/deletecomment/${commentid}`,{
    method:"DELETE"
