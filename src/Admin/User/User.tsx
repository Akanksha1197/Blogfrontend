...
const Users:React.FC = () => {
    ...
    useEffect(() => {
        const fetchUsers = async () => {
            const response = await fetch('https://blogappbackend-980x75kmb-akankshas-projects-76b3734f.vercel.app/api/blogs');
            if (response.ok) {
    ...
    const Delete=async(postId:string)=>{
        ...
        const response=await fetch(`https://blogappbackend-980x75kmb-akankshas-projects-76b3734f.vercel.app/api/deletepost/${postId}`,{
          method:'DELETE',
